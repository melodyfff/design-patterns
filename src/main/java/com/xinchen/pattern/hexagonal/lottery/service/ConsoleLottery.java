package com.xinchen.pattern.hexagonal.lottery.service;
...
import com.xinchen.pattern.hexagonal.lottery.domain.LotteryTicketCheckResult;
...
public class ConsoleLottery {
    ...
    private static void submitTicket(LotteryService service, Scanner scanner) {
        ...
        LOGGER.info("Give 4 comma separated lottery numbers? ex: 1,2,3,4");
        String numbers = readString(scanner);
        try {
            String[] parts = numbers.split(",");
